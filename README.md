...
## Datasets
We provide **6 city-scale datasets** collected from the largest U.S. cities, which are briefly described as follows: 
...
The data entries of above mentioned datasets are summarized as below:
